...
os.chdir(r'C:\Users\HP\Desktop\Age-and-Gender-Recognition-main\models')
...
# python Age-and-Gender-Recognition.py --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel
